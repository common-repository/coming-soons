<style>
	#RW_Load_Content
	{
		...
		top:0px;
		left:0px;
		background-color:<?php echo esc_attr( $rw_cs_loader['rw_cs_loader_BgC'] ); ?>;
		z-index:999;
		width:100%;
		height:100%;
	}
	...
	.RW_Loader_Text
	{
		...
		text-align:center;
		top:45%;
		font-size:<?php echo esc_attr( $rw_cs_loader['rw_cs_loader_Text_FS'] ); ?>px;
		font-family:<?php echo esc_attr( $rw_cs_loader['rw_cs_loader_Text_FF'] ); ?>;
		color:<?php echo esc_attr( $rw_cs_loader['rw_cs_loader_Text_C'] ); ?>;
	...
	.loader1
	{
		border-top:5px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader3_C'] ); ?>;
		border-bottom:5px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader3_C'] ); ?>;
	...
	.loader2
	{
		border-left:5px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader2_C'] ); ?>;
		border-right:5px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader2_C'] ); ?>;
		-webkit-box-sizing:border-box;
		-ms-box-sizing:border-box;
		-moz-box-sizing:border-box;
		-o-box-sizing:border-box;
	...
	.loader3
	{
		width:60%;
		height:60%;
		border-top:25px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader1_C'] ); ?>;
		border-bottom:25px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader1_C'] ); ?>;
		border-right:25px solid <?php echo esc_attr( $rw_cs_loader['rw_cs_loader1_C'] ); ?>;
		top:50%;
		left:50%;
		box-sizing:border-box;
		-webkit-box-sizing:border-box;
	...
	<?php echo esc_attr( $rw_cs_loader['rw_cs_loader_Custom_CSS'] ); ?>
</style>
<div id="RW_Load_Content">
	...
	<?php if ( $rw_cs_loader['rw_cs_loader_Text_Show'] == 'show' ) { ?>
		<div class="RW_Loader_Text">
			<?php echo esc_attr( $rw_cs_loader['rw_cs_loader_Text'] ); ?>
		</div>
	<?php } ?>
</div>
