...
<form id="Rich_Web_CCS_Form">
	...
	<input type='text' style='display:none;' id="Rich_Web_CS_Forms_New_Co" name='Rich_Web_CS_Forms_New_Co' value="<?php echo esc_attr( count( $Rich_Web_CS_Forms_Dat ) ); ?>">
	...
	<div class="Rich_Web_CS_Forms_Fields_Content" id="Rich_Web_CS_Forms_Fields_Content" onmousemove="Rich_Web_CS_Forms_FC_Sortable()">
		<?php
		$Rich_Web_CS_Forms_Dat_length = count( $Rich_Web_CS_Forms_Dat );
		for ( $i = 0; $i < $Rich_Web_CS_Forms_Dat_length; $i++ ) {
			...
			?>
			<div style="width:<?php echo esc_attr( $Width ); ?>;" class="Rich_Web_CS_Forms_FC" id="Rich_Web_CS_Forms_Field_<?php echo esc_attr( absint( $i ) + 1 ); ?>">
				<div class="Rich_Web_CS_Forms_FC_No">
					<span><?php echo esc_attr( absint( $i ) + 1 ); ?></span>
				</div>
				<div class="Rich_Web_CS_Forms_FC_C">
					<span class="Rich_Web_CS_Forms_FC_C_Span" data-type="minus" onclick="Rich_Web_CS_Forms_FC_C_Span_Clicked(<?php echo esc_attr( absint( $i ) + 1 ); ?>)">-</span>
					<span class="Rich_Web_CS_Forms_FC_C_Span" data-type="plus" onclick="Rich_Web_CS_Forms_FC_C_Span_Clicked(<?php echo esc_attr( absint( $i ) + 1 ); ?>)">+</span>
				</div>
				<div class="Rich_Web_CS_Forms_FC_Lab">
					<label><?php echo esc_attr( $Width1 ); ?></label>
					<label><?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Forms_Fields_Type ); ?></label>
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FF" id="Rich_Web_CS_Forms_Field_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value='<?php echo esc_attr( html_entity_decode( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Forms_Fields ) ); ?>'>
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FW" id="Rich_Web_CS_Forms_Field_W_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_W_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Forms_Fields_Width ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FT" id="Rich_Web_CS_Forms_Field_T_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_T_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Forms_Fields_Type ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO1" id="Rich_Web_CS_Forms_Field_O1_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O1_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value='<?php echo esc_attr( html_entity_decode( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O1 ) ); ?>'>
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO2" id="Rich_Web_CS_Forms_Field_O2_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O2_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O2 ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO3" id="Rich_Web_CS_Forms_Field_O3_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O3_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O3 ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO4" id="Rich_Web_CS_Forms_Field_O4_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O4_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O4 ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO5" id="Rich_Web_CS_Forms_Field_O5_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O5_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O5 ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO6" id="Rich_Web_CS_Forms_Field_O6_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O6_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O6 ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO7" id="Rich_Web_CS_Forms_Field_O7_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O7_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Dat[ $i ]->CS_Rich_Web_Forms_Fields_O7 ); ?>">
					<input type="text" style="display:none" class="Rich_Web_CS_Forms_FO8" id="Rich_Web_CS_Forms_Field_O8_<?php echo esc_attr( absint( $i ) + 1 ); ?>" name="Rich_Web_CS_Forms_Field_O8_<?php echo esc_attr( absint( $i ) + 1 ); ?>" value="">
					<i class="Rich_Web_CS_Forms_FC_LabEdit rich_web rich_web-pencil" aria-hidden="true"></i>
					<i class="Rich_Web_CS_Forms_FC_LabCopy rich_web rich_web-files-o" aria-hidden="true" onclick="Rich_Web_CS_Forms_FC_LabCopy_Clicked(<?php echo esc_attr( absint( $i ) + 1 ); ?>)"></i>
					<i class="Rich_Web_CS_Forms_FC_LabRemove rich_web rich_web-trash" aria-hidden="true" onclick="Rich_Web_CS_Forms_FC_LabRemove_Clicked(<?php echo esc_attr( absint( $i ) + 1 ); ?>)"></i>
				</div>
			</div>
		<?php } ?>
	</div>
	...
	<input type="hidden" name="rw_web-nonce-1" value="<?php echo esc_attr( wp_create_nonce('rw_web-manager-nonce')); ?>">
...
if ( isset( $_POST['save_form_CS'] ) == 'save_form_CS' ) {
	...
	$Rich_Web_CS_Forms_New_Co = isset($_POST['Rich_Web_CS_Forms_New_Co']) ? sanitize_text_field( $_POST['Rich_Web_CS_Forms_New_Co'] ):'';
	...
	for ( $i = 1;$i <= $Rich_Web_CS_Forms_New_Co;$i++ ) {
		$Rich_Web_CS_Forms_FF[ $i ]        = isset( $_POST[ 'Rich_Web_CS_Forms_Field_' . $i ] )?str_replace( '\&', '&', sanitize_text_field( esc_html( $_POST[ 'Rich_Web_CS_Forms_Field_' . $i ] ) ) ):'';
		$Rich_Web_CS_Forms_FW[ $i ]        = isset( $_POST[ 'Rich_Web_CS_Forms_Field_W_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_W_' . $i ] ):'';
		$Rich_Web_CS_Forms_FT[ $i ]        = isset( $_POST[ 'Rich_Web_CS_Forms_Field_T_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_T_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O1[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O1_' . $i ] ) ?str_replace( '\&', '&', sanitize_text_field( esc_html( $_POST[ 'Rich_Web_CS_Forms_Field_O1_' . $i ] ) ) ):'';
		$Rich_Web_CS_Forms_Fields_O2[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O2_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O2_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O3[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O3_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O3_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O4[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O4_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O4_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O5[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O5_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O5_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O6[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O6_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O6_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O7[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O7_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O7_' . $i ] ):'';
		$Rich_Web_CS_Forms_Fields_O8[ $i ] = isset( $_POST[ 'Rich_Web_CS_Forms_Field_O8_' . $i ] )?sanitize_text_field( $_POST[ 'Rich_Web_CS_Forms_Field_O8_' . $i ] ):'';
	}
	for ( $i = 1;$i <= $Rich_Web_CS_Forms_New_Co;$i++ ) {
