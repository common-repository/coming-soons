...
function RW_CS_Seo()
{
	...
	jQuery.ajax(
	{
		...
		data : {
			...
			'rw_cs_nonce_field':rw_cs_object.nonce,
		},
...
function RW_CS_Form()
{
	...
	fd.append('rw_cs_nonce_field', rw_cs_object.nonce);
