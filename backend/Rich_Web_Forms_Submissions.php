...
<form id="save_form_CS_SO">
	<div class='Rich_Web_CS_Forms_Content_Submission'>
		<div class='Rich_Web_CS_Forms_Content_Data2_Submission'>
			<input type="text" style="display: none;" id="Rich_Web_CS_Forms_Spam" value="<?php echo esc_attr( $Rich_Web_CS_Forms_Options[0]->Rich_Web_CS_Forms_O_9 ); ?>">
			<input type="text" style="display: none;" id="Rich_Web_CS_Forms_AAU" value="<?php echo admin_url( 'admin-ajax.php' ); ?>">
			<input type="text" style="display: none;" id="Rich_Web_CS_Forms_LFI" value="<?php echo esc_url( plugins_url( '/Images/Flags/', __FILE__ ) ); ?>">
			<img src="<?php echo esc_url( plugins_url( '/Images/Submissions.PNG', __FILE__ ) ); ?>">
		</div>
	</div>
	
	<input type="hidden" name="rw_web-nonce-1" value="<?php echo esc_attr( wp_create_nonce('rw_web-submission-nonce')); ?>">
